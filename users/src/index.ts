...
async function startServer() {
  ...
  try {
    await syncDepartmentsProjectionFromEventBus();
    console.log(`Service: ${SERVICE_NAME} - Department projection sync completed`);
  } catch (syncError) {
    console.warn(`Service: ${SERVICE_NAME} - Department projection sync failed`, syncError);
  }
